...
const Testimonials = dynamic(() => import('@/components/Testomonials'), {
...
const WhyWe = dynamic(() => import('@/components/WhyWe'), {
  loading: () => <div className="h-80 animate-pulse bg-gray-100 dark:bg-gray-800 rounded-lg" />
});
...
export default async function Home() {
  return (
    ...
    <p className='w-full min-h-screen h-screen flex items-center justify-center dark:text-white text-black font-medium text-xl'>Site is under construction...</p>
