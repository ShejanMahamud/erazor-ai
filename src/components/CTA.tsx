...
const CTA: React.FC = () => {
  return (
    <div
      className='relative mx-auto flex w-[80%] flex-col items-center justify-center overflow-hidden rounded-2xl border border-[#ffffff1a] bg-[#0E0E0E] py-28'
      style={{
    ...
    >
      ...
      <div className='absolute inset-0 bg-gradient-to-br from-orange-500/10 via-purple-600/5 to-transparent opacity-80' />
      ...
      <svg
        xmlns='http://www.w3.org/2000/svg'
        className='absolute top-5 left-40 z-10'
        width='47'
        height='47'
        viewBox='0 0 47 47'
        fill='none'
      ...
      <svg
        ...
        viewBox='0 0 52 52'
        fill='none'
        className='absolute right-40 bottom-10 z-10'
      >
        <path
